...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  static const List<_PaymentOption> _paymentOptions = [
    _PaymentOption(
      value: 'global_institute_pay', // ← Nilai dikirim ke backend
      label: 'Nan Emoney Pay', // ← Label tampilan
      subtitle: 'Bayar via Nan Emoney',
      icon: Icons.school_rounded, // ← Ikon kampus
      iconColor: Color(0xFF1A237E), // ← Biru tua akademis
    ),
    _PaymentOption(
      value: 'bank_transfer',
      label: 'Transfer Bank',
  ...
  Future<void> _placeOrder(BuildContext context) async {
    ...
    if (success) {
      ...
      final needsPaymentFlow =
          ...
          order.paymentMethod ==
              'global_institute_pay'; // ← Global Institute Pay
