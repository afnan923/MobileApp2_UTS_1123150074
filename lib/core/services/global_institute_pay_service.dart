...
void _log(String tag, String message) {
 debugPrint('[PaketAlatPancing/$tag] $message');
}
...
class GlobalInstitutePayService {
 ...
 _log(_tag, 'merchant_id : MCH_PAKET_ALAT_PANCING');
 _log(_tag, 'merchant_name: Paket Alat Pancing');
 ...
 host: host,
 queryParameters: {
 'merchant_id': 'MCH_PAKET_ALAT_PANCING',
 'merchant_name': 'Paket Alat Pancing',
